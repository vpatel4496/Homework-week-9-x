...
/*  The Swimming Company has asked you to write an apllication that calculates the volume of cuboid shaped pools.
    ...
    *   System.out.println("cuboid.width= " + cuboid.getLength():
